...
r.errors=struct('max', 2.5*10^(-1) ...
    , 'calculated', NaN ...
    , 'simulated', NaN ...
    );


da.values=struct('coefficient', 2.5*10^(-3) ...
    , 'type', 1 ...
    , 'frequency', -1 ...
    , 'order', 0 ...
    , 'tf', 1 ...
...
da.errors=struct('max', 1*10^(-2) ...
    , 'calculated', NaN ...
    , 'simulated', NaN ...
    );


dp.values=struct('coefficient', 8.5*10^(-3) ...
    , 'type', 1 ...
    , 'frequency', -1 ...
    , 'order', 1 ...
    , 'tf', Gd ...
...
dp.errors=struct('max', 1.5*10^(-3) ...
    , 'calculated', NaN ...
    , 'simulated', NaN ...
    );

ds.values=struct('coefficient', 5*10^(-2) ...
    , 'type', 2 ...
    , 'frequency', 40 ...
    , 'order', -1 ...
    , 'tf', 1 ...
...
riseTime.on=1;
riseTime.maxValue=3.5;

overshoot.on=1;
overshoot.maxValue=0.15;

settlingTime.on=1;
settlingTime.maxValue=14;
settlingTime.tolerance=0.05;

%% Plant Values
Gp.inputString='(-30)/((s^3 + 3*s^2 + 2*s))';
