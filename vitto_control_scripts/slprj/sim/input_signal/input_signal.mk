...
MODEL                   = input_signal
MODULES                 = input_signal.c input_signal_capi.c 
MAKEFILE                = input_signal.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\Vittorio\FILES\School\SINTES~1\Scripts\MATLAB~1\VITTO_~1
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f "$(MATLAB_BIN)\win64\mexopts\msvc90opts.bat"
COMPUTER                = PCWIN64
...
MODELLIB                  = input_signallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = input_signal_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\sim\input_signal
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	...
	$(LD) $(LDFLAGS) $(S_FUNCTIONS_LIB) $(SHARED_LIB) $(LIBS) \
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(RTW_SFUN_SRC) $(MODELREF_LINK_LIBS)
	...
	$(MEX) $(MEX_OPT_OPTS) $(MEX_ARCH) $(MEX_OPT_FILE) $(MODELREF_INC_PATH) $(RTW_SFUN_SRC) $(MODELLIB) @$(MODELREF_LINK_RSPFILE) $(SHARED_LIB) $(LIBS) -outdir $(RELATIVE_PATH_TO_ANCHOR)
